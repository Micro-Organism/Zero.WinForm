        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            if (this.Parent != null)
            {
                ...
                try
                {
                    ...
                    Point _imgpos = new Point((this.Width - _img.Width) / 2, 4);
                    Rectangle r = new Rectangle(_imgpos, new Size(_img.Width, _img.Height));
                    ...
                    if (this.Enabled)
                    {
                        g.DrawImage(_img, r, 0, 0, _img.Width, _img.Height, GraphicsUnit.Pixel, null);
                    }
                    else
                    {
                        g.DrawImage(_img, r, 0, 0, _img.Width, _img.Height, GraphicsUnit.Pixel, attributes);
                    }
                }
                catch { }
